...
ActiveRecord::Schema.define(version: 2021_10_06_183827) do
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.integer "property_region_id", null: false
    t.integer "property_owner_id", null: false
    t.index ["property_owner_id"], name: "index_properties_on_property_owner_id"
    t.index ["property_region_id"], name: "index_properties_on_property_region_id"
  ...
  create_table "property_regions", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  add_foreign_key "properties", "property_regions"
