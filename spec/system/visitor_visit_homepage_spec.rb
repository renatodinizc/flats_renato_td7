...
describe 'Visitor visits homepage' do
    ...
    it 'and sees all avaiable properties in database' do
        ...
        create(:property, property_owner: property_owner, property_region: praia)
        create(:property, property_owner: property_owner, property_region: campo,
                title: 'Apartamento em Manaus', description: 'Ótimo preço, perto do Rio Negro', rooms: 2)
